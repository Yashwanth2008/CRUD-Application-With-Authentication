!(function (e) {
  ...
  function (e, t, n) {
      ...
      function e() {
        !(function (e, t) {
          ...
          (this.SDK_INFO = {
            ...
            NAME: "zohoCatalyst",
            INITIALIZED: !1,
            RETRIES: { NETFAIL: { 404: { COUNT: 0, DELAY: 0 } } },
            POLL_INTERVAL: 1e3,
            POLL_THRESHOLD: 0,
            TOKEN_EXPIRY_TIME: 0,
          }),
        ...
        (n = [
          {
            key: "getRetryCount",
            value: function (e) {
              return e in this.SDK_INFO.RETRIES.NETFAIL
                ? this.SDK_INFO.RETRIES.NETFAIL[e].COUNT
                : null;
            },
          },
          {
    ...
    (t.ConfigManager = i), (i.INSTANCE = null);
  },
  function (e, t, n) {
    "use strict";
    function r(e, t) {
  ...
  function (e, t, n) {
    ...
    function a(e) {
      try {
        ...
        o.ErrorHandler.constructError(
          o.developerET.NO_CONSTRUCTOR,
          [c(e)],
          o.ET_Mode.developerET
        );
      }
    }
    function c(e) {
      try {
        ...
        o.ErrorHandler.constructError(
          o.developerET.ILLEGAL_TYPECAST,
          [e, a(i.CONSTANT.EMPTY_STRING), c(t)],
          o.ET_Mode.developerET
        );
      }
    }
  ...
  function (e, t, n) {
    ...
    !(function (e) {
      ...
      (t.appET = {
        NO_APP: { template: "Unable to initialize #{0}()!", code: "no-app" },
        NO_REQ_FOUND: {
        ...
        NOT_SATISFY: {
          template:
            "Given parameter does not satisfied #{0} constrains,It should be #{1} #{2}",
          code: "not-satisfy",
        },
        NOT_ACCEPT: {
        ...
        UNKNOWN: { template: "Something went wrong!", code: "unknown" },
        NOT_INITIALIZED: {
          template:
            "CatalystApp not initialized!, Initialize CatalystApp properly with CatalystCredential instance to continue!",
          code: "bad-access",
        },
        NOT_ACTIVE: {
          template:
            "Looks like you have not signed in, Please signin to continue!",
          code: "not-active",
        },
      }),
      (t.serverET = {
        ...
        (c = [
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              switch (e) {
                case o.appET:
                  throw new a.CatalystAppError(
                    t.code,
                    t.template,
                    n,
                    i.ERROR_CODE_MAP.APP_ERROR
                  );
                case o.serverET:
                  throw new a.CatalystServerError(
                    t.code,
                    t.template,
                    n,
                    i.ERROR_CODE_MAP.SERVER_ERROR
                  );
                case o.developerET:
                  throw new a.CatalystDeveloperError(
                    t.code,
                    t.template,
                    n,
                    i.ERROR_CODE_MAP.DEVELOPER_ERROR
                  );
              }
            },
          },
          ...
          (u = [
            {
              ...
              value: function (e, t, n) {
                ...
                return (
                  !(
                    (n === i.STRING_LENGTH_CONDITION.EXACT && u != t) ||
                    (n === i.STRING_LENGTH_CONDITION.GREATER_THAN && u <= t) ||
                    (n === i.STRING_LENGTH_CONDITION.LESS_THAN && u >= t) ||
                    (n === i.STRING_LENGTH_CONDITION.LESS_THAN_EQUAL &&
                      u > t) ||
                    (n === i.STRING_LENGTH_CONDITION.GREATER_THAN_EQUAL &&
                      u < t)
                  ) ||
                  (r &&
                    o.ErrorHandler.constructError(
                      o.appET.NOT_SATISFY,
                      ["stringLength", n, c.str(t)],
                      o.ET_Mode.appET
                    ),
                  !1)
                );
        ...
        return (
          ...
          (c = [
            ...
            },
            {
              key: "validStr",
              value: function (e) {
                a.type(i.CONSTANT.EMPTY_STRING) != a.type(e) &&
                  o.ErrorHandler.constructError(
                    o.appET.MISMATH,
                    [a.typeOf(i.CONSTANT.EMPTY_STRING), a.typeOf(e)],
                    o.ET_Mode.appET
                  );
              },
            },
            {
              key: "validObject",
              value: function (e) {
                a.type(i.CONSTANT.EMPTY_OBJECT) != a.type(e) &&
                  o.ErrorHandler.constructError(
                    o.appET.MISMATH,
                    [a.typeOf(i.CONSTANT.EMPTY_OBJECT), a.typeOf(e)],
                    o.ET_Mode.appET
                  );
              },
            },
            {
              key: "validArray",
              value: function (e) {
                a.type(i.CONSTANT.EMPTY_ARRAY) != a.type(e) &&
                  o.ErrorHandler.constructError(
                    o.appET.MISMATH,
                    [a.typeOf(i.CONSTANT.EMPTY_ARRAY), a.typeOf(e)],
                    o.ET_Mode.appET
                  );
              },
            },
          ...
          (_ = [
            {
              ...
              value: function (t, n) {
                ...
                return e.attachAuthHeaders(t.headers).then(function (o) {
                  ...
                  t.method !== u.HTTP_METHODS.GET &&
                    null !== t.body &&
                    (i.body = t.body);
                  var c = a.ConfigManager.getInstance().APIDomain
                    ? ""
                        .concat(a.ConfigManager.getInstance().APIDomain)
                        .concat(t.url)
                    : t.url;
                  return fetch(c, i)
                    .then(function (r) {
                      if (
                        r.status !== u.HTTP_CODE_MAP.OK.CODE &&
                        null === n.retry
                      ) {
                        var o = a.ConfigManager.getInstance().getRetryCount(
                          r.status
                        );
                        n.retry = null !== o ? o : 0;
                      }
                      return r.status === u.HTTP_CODE_MAP.OK.CODE ||
                        n.retry <= 0
                        ? e.wrapResponse(r)
                        : e.fireGeneralRequest(t, e.reduceRetryCount(n));
                    })
                    .catch(function (e) {
                      s.ErrorHandler.constructError(
                        s.serverET.NET_ISSUE,
                        [],
                        s.ET_Mode.serverET
                      );
                    });
              ...
              value: function (t) {
                ...
                return e.attachAuthHeaders(t.headers).then(function (e) {
                  ...
                  t.method !== u.HTTP_METHODS.GET &&
                    null !== t.body &&
                    (r.body = t.body);
                  var o = a.ConfigManager.getInstance().APIDomain
                    ? ""
                        .concat(a.ConfigManager.getInstance().APIDomain)
                        .concat(t.url)
                    : t.url;
              ...
              value: function (t, n, r, o) {
                ...
                return (
                  (f.withCredentials = !0),
                  {
                    start: function () {
                      return e
                        .attachAuthHeaders(c.CONSTANT.EMPTY_OBJECT)
                        .then(function (o) {
                          return new Promise(function (c, s) {
                            var E = a.ConfigManager.getInstance().APIDomain
                              ? ""
                                  .concat(
                                    a.ConfigManager.getInstance().APIDomain
                                  )
                                  .concat(t.url)
                              : t.url;
                            f.open(r, E),
                              ...
                              r === u.HTTP_METHODS.GET &&
                                (f.responseType = i.REQUEST_PROPERTY.BLOB),
                              n &&
                              ...
                              (f.onload = function () {
                                c(
                                  e.wrapFileResponse(
                                    e.wrapResponse(
                                      { data: f.response, status: f.status },
                                      !0
                                    )
                                  )
                                );
            ...
            },
            {
              ...
              value: function (e) {
                e.Accept
                  ? (e.Accept = "application/vnd.catalyst.v2+json, " + e.Accept)
                  : (e.Accept = "application/vnd.catalyst.v2+json");
                var t = a.ConfigManager.getInstance();
                return (
                  "string" == typeof (null == t ? void 0 : t.OrgId) &&
                    (e["CATALYST-ORG"] = t.OrgId),
            ...
            },
            {
              ...
              value: function (e) {
                var t =
                    ...
                    arguments[1],
                  n =
                    e.status === u.HTTP_CODE_MAP.NO_CONTENT.CODE || t
                      ? new Promise(function (n) {
                          var r = { data: c.CONSTANT.EMPTY_OBJECT };
                          if (t) {
                ...
                return n.then(function (t) {
                  ...
                  return (
                    e.status && n.message
                      ? ((i = e.status), (a = n.message), delete n.message)
                      : c && ((i = c.CODE), (a = c.TEXT)),
                    new E(i, n, a, r, o)
                  );
                });
            ...
            },
            {
              ...
              value: function (e) {
                return l.Auth.collectZCRFToken()
                  .then(function () {
                    var t = a.ConfigManager.getInstance();
                    return (
                      (e[c.CONSTANT.X_ZCSRF_TOKEN] = ""
                        .concat(c.CONSTANT.ZD_CSRPARAM, "=")
                        .concat(t.CsrfToken)),
                      e
                    );
                  })
            ...
            },
            {
              ...
              value: function (e) {
                return this.getJWTAuthToken()
                  .then(function (t) {
                    return (
                      (e[i.HTTP_HEADER_MAP.AUTHORIZATION_KEY] = t.access_token),
                      e
                    );
                  })
                  .catch(function (e) {
            ...
            },
            {
              ...
              value: function () {
                ...
                return new Promise(function (n, r) {
                  ...
                  "" === o
                    ? e
                        .triggerJwtAccessToken()
                        .then(function (e) {
                          (t.jwtAuthToken = e.access_token),
                            n({
                              access_token: ""
                                .concat(t.jwtAuthTokenPrefix, " ")
                                .concat(t.jwtAuthToken),
                            });
                        })
                        .catch(function (e) {
                          r(e);
            ...
            },
            {
              ...
              value: function () {
                for (
                  ...
                  var o = t[r].split("=");
                  o[0].trim() ===
                    a.ConfigManager.getInstance().jwtTokenCookieKey &&
                    (e = o[1]);
                }
                return e;
              },
            },
            {
              ...
              value: function () {
                ...
                return e.fetchJwtDetailsCallBack().then(function (t) {
                  (e.jwtClientId = t.client_id), (e.jwtToken = t.jwt_token);
                  var n = {};
                  return (
                    (n.response_type = e.jwtResponseType),
                    (n.scope = t.scopes),
                    ...
                    new Promise(function (t, r) {
                      fetch(
                        f.applyQueryString(
                          ""
                            .concat(e.IAMDomainUrl, "/clientoauth/v2/")
                            .concat(e.ZAID, "/remote/auth"),
                          n
                        ),
                        { method: "POST" }
                      ).then(function (n) {
                        n.json().then(function (n) {
                          (e.AuthProtocol = a.Auth_Protocol.JwtTokenProtocol),
                            n.access_toke || n.access_token
                              ? ((e.jwtAuthToken = n.access_token
                                  ? n.access_token
                                  : n.access_toke),
                                (document.cookie = ""
                                  .concat(e.jwtTokenCookieKey, "=")
                                  .concat(e.jwtAuthToken, "; max-age=")
                                  .concat(n.expires_in_sec, "; path=/")),
                                t({ access_token: e.jwtAuthToken }))
                              : r(n);
                        });
                      });
                    })
  ...
  function (e, t, n) {
          ...
          (n = [
            {
              ...
              value: function (e, t) {
                ...
                if (
                  (o.__init__.bindGlobal("__catalyst", Object.freeze(e)),
                  ...
                  o.__init__.initProcess(),
                    (e = e.hasOwnProperty("credentialQR")
                      ? y.toUpperCaseKeys(e.credentialQR)
                      : y.toUpperCaseKeys(e));
                  var r = !0,
                    l = !1,
                    f = void 0;
                  try {
                    for (
                      var E, _ = c.REQUIREMENT.INIT_REQUIRE[Symbol.iterator]();
                      !(r = (E = _.next()).done);
                      r = !0
                    ) {
                      var T = E.value;
                      e.hasOwnProperty(T.toUpperCase()) ||
                        u.ErrorHandler.constructError(
                          u.appET.NO_REQ_FOUND,
                          [T],
                          u.ET_Mode.appET
                        );
                    }
                  ...
                  (n.ZAID = e[a.CONSTANT.ZAID]),
                    ...
                    (n.IAMDomainUrl = e[a.CONSTANT.ACCOUNTS_PORTAL_DOMAIN]
                      ? e[a.CONSTANT.ACCOUNTS_PORTAL_DOMAIN]
                      : "https://accounts.zohoportal.com"),
                    (n.APIDomain = e[a.CONSTANT.API_DOMAIN]),
                    (n.ServiceURL = "".concat(
                      n.CurrentClientPageDomain,
                      "/baas"
                    )),
                    (n.RestBase = ""
                      .concat(n.DomainUrl, "/")
                    ...
                    (n.BaseURL = ""
                      .concat(n.RestBase, "/")
                      .concat(c.APP_URL_DIVIDER.PROJECT, "/")
                      .concat(n.ProjectID)),
                    e[a.CONSTANT.IS_APPSAIL] &&
                    "true" == e[a.CONSTANT.IS_APPSAIL]
                      ? (n.IsAppSail = e[a.CONSTANT.IS_APPSAIL])
                      : (n.IsAppSail = "false"),
                    (null == t ? void 0 : t.isLocalzoho) &&
                      (n.IAMDomainUrl = "https://accounts.localzohoportal.com"),
                    (null == t ? void 0 : t.org_id) && (n.OrgId = t.org_id),
                    (n.Initialized = !0),
                    s.CommonPool.getInstance().addCommonInstance(
                      c.COMMONPOOL_NAME,
                      this
                    );
                }
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = e.toUpperCase();
                if (n in this.FEATURE_INSTANCE) return this.FEATURE_INSTANCE[n];
                var r = t();
                return null !== r && (this.FEATURE_INSTANCE[n] = r), r;
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                if (i.ConfigManager.getInstance().Initialized) return !0;
                u.ErrorHandler.constructError(
                  u.appET.NOT_INITIALIZED,
                  [],
                  u.ET_Mode.appET
                );
              },
    ...
    (t.CatalystApp = I), o.__init__.globalProcess();
  },
  function (e, t, n) {
    "use strict";
    function r(e, t) {
    ...
    var o = n(62),
      ...
      c = (function () {
        ...
        return (
          (t = e),
          (c = [
            { key: "initProcess", value: function () {} },
            {
              key: "globalProcess",
              value: function () {
                e.bindGlobal(a.CONSTANT.APP_GLOBAL_NAME, new i.CatalystApp()),
                  e.bindGlobal(
                    a.CONSTANT.CREDENTIALS_GLOBAL_NAME,
                    o.Credential
                  );
              },
            },
            ...
            },
            {
              ...
              value: function (e, t) {
                if (void 0 === window["__catalyst.env"]) {
                  var n = new Map();
                  n.set(e, t), (window["__catalyst.env"] = n);
                } else {
                  var r = window["__catalyst.env"];
                  r.set(e, t), (window["__catalyst.env"] = r);
                }
              },
            },
            {
              ...
              value: function (e) {
                return void 0 !== window["__catalyst.env"]
                  ? window["__catalyst.env"].get(e)
                  : null;
              },
            },
            {
              ...
              value: function (e) {
                if (void 0 !== window["__catalyst.env"]) {
                  ...
                  t.delete(e), (window["__catalyst.env"] = t);
                }
              },
            },
          ]),
          ...
          (T = [
            {
              ...
              value: function () {
                return document
                  .getElementById("iam_iframe")
                  .contentDocument.getElementById("login_id_container")
                  ...
                  try {
                    ...
                    try {
                      for (
                        ...
                        if (
                          2 === l.length &&
                          l[0].trim() === a.CONSTANT.CSRF_TOKEN_KEY &&
                          l[1].trim().length > 0
                        )
                          return (
                            (i.ConfigManager.getInstance().CsrfToken =
                              l[1].trim()),
                            void e()
                          );
                      }
          ...
          (n = [
                ...
                var t = this,
                  n =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ? arguments[1]
                      : {};
                n.signin_providers_only &&
                  (n.signInProvidersOnly = n.signin_providers_only),
                  this.isValidUser()
                    .then(function (r) {
                      if (200 === r.status) {
                        var o = i.ConfigManager.getInstance();
                        window.location.href = ""
                          .concat(o.CurrentClientPageDomain, "/__catalyst/")
                          .concat(
                            o.ProjectID,
                            "/auth/signin-redirect?PROJECT_ID="
                          )
                          .concat(o.ZAID);
                      } else t.notSignedIn(e, n);
                    })
                    .catch(function (r) {
                      t.notSignedIn(e, n);
                    });
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = this;
                return (
                  t.signin_providers_only &&
                    (t.signInProvidersOnly = t.signin_providers_only),
                          ...
                          function (n) {
                            for (;;)
                              switch ((n.prev = n.next)) {
                                case 0:
                                  return (n.next = 2), this.publicSignup();
                                case 2:
                                  (o = n.sent),
                                    (i = o.content.public_signup),
                                    (a = this.createIframeAndAttach(
                                      e,
                                      this.constructIAMIframeUrl(t, i)
                                    )) &&
                                      (a.onload = function () {
                                        var n =
                                        ...
                                        if (
                                          ((o.getElementById(
                                            ...
                                            f.AUTH_ERROR_MSG.emptyEmailAddress),
                                          ...
                                          if (
                                            ...
                                            (s.innerText =
                                              ...
                                              i.parentElement.parentElement.appendChild(
                                                s
                                              );
                                          }
                                        }
                                        o.getElementById("forgotpassword") &&
                                          ((o
                                            .getElementById("forgotpassword")
                                            .querySelector("a").onclick =
                                            function () {
            ...
            },
            {
              key: "publicSignup",
              value: function () {
                return c.RequestHandler.get(
                  "/"
                    .concat(f.URL_DIVIDER.RESERVED_URL, "/")
                    .concat(f.URL_DIVIDER.AUTH, "/")
                    .concat(f.URL_DIVIDER.PUBLIC_SIGNUP)
                );
              },
            },
            {
              ...
              value: function (e, t) {
                if (void 0 !== e && void 0 !== t) {
                  ...
                  var n = ""
                      .concat(this.URL, "/")
                      .concat(E.USER_MANAGEMENT_URL_DIVIDER.PROJECT_USER, "/")
                      .concat(f.URL_DIVIDER.CHANGE_PASSWORD),
                    r = s.applyQueryString(n, {
                      old_password: e,
                      new_password: t,
                    });
                  return c.RequestHandler.put({ url: r, body: null });
                }
                console.error(
                  "Change password error: Two arguments (oldPassword, newPassword) expected."
                );
              },
            },
            {
              ...
              value: function (t, n) {
                ...
                try {
                  for (
                    ...
                    if (
                      "attributes" === u.type &&
                      "block" === u.target.style.display
                    ) {
                      var s = e.getEmailInpErrorDiv();
                      s.innerText
                        .toLowerCase()
                        .includes(f.AUTH_ERROR_MSG.noAccountIncludes) &&
                        (s.innerText = f.AUTH_ERROR_MSG.noAccountMsg);
                    }
                  }
                } catch (e) {
                  (o = !0), (i = e);
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = this,
                  r = this.createIframeAndAttach(
                    t.forgot_password_id ? t.forgot_password_id : e,
                    this.getIAMForgotPasswordURL(t)
                  );
                r &&
                  (r.onload = function () {
                    ...
                    (e.contentWindow.document.getElementById(
                      "login_id"
                    ).placeholder = f.AUTH_ERROR_MSG.emptyEmailAddress),
            ...
            },
            {
              ...
              value: function (e) {
                if (e.contentWindow.I18N) {
                  ...
                  (t["IAM.PHONE.ENTER.VALID.MOBILE_NUMBER"] =
                    f.AUTH_ERROR_MSG.emptyEmailAddress),
                    (t["IAM.NEW.SIGNIN.ENTER.EMAIL.OR.MOBILE"] =
                      f.AUTH_ERROR_MSG.emptyEmailAddress);
                }
              },
            },
            {
              ...
              value: function (e, t) {
                ...
                if (null === n)
                  return (
                    console.error("Unable to get element with id : ".concat(e)),
                    !1
                  );
            ...
            },
            {
              ...
              value: function (e) {
                ...
                n.AuthProtocol === i.Auth_Protocol.JwtTokenProtocol
                  ? (document.cookie = ""
                      .concat(n.jwtTokenCookieKey, "=; path=/; expires=")
                  ...
                  ? this.isValidUser()
                      .then(function (r) {
                        401 === r.status &&
                          (e.startsWith("/") &&
                            (e =
                              "" != n.CurrentClientPagePort
                                ? ""
                                    .concat(n.CurrentClientPageProtocol, "//")
                                    .concat(n.CurrentClientPageHost, ":")
                                    .concat(n.CurrentClientPagePort)
                                    .concat(e)
                                : ""
                                    .concat(n.CurrentClientPageProtocol, "//")
                                    .concat(n.CurrentClientPageHost)
                          ...
                          c.RequestHandler.get(t.constructSignOutUrl(e)).then(
                            function (t) {
                              (document.cookie =
                                "CAUTH=; path=/accounts; expires=".concat(
            ...
            },
            {
              ...
              value: function (e) {
                return l.ResponseHandler.wrapResponse(
                  {
                    data: JSON.stringify({
                      data: { signout_url: this.constructSignOutUrl(e) },
                    }),
                  },
                  !0
                );
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return s
                  .wrapPrimaryCheckWithPromise(function () {
                    u.PropertyCheckFilter.hasSuffInfo(e, [
                      f.signUpProperty.LAST_NAME,
                      f.signUpProperty.EMAIL_ID,
                    ]);
                  })
                  .then(function () {
                    var n = {};
                    (n[f.signUpProperty.ZAID] = t.ZAID),
                      (n[f.signUpProperty.PLATFORM] =
                        void 0 === e[f.signUpProperty.PLATFORM]
                          ? "web"
                          : e[f.signUpProperty.PLATFORM]),
                      void 0 !== e[f.signUpProperty.REDIRECT_URL] &&
                        (n[f.signUpProperty.REDIRECT_URL] =
                          e[f.signUpProperty.REDIRECT_URL]);
                    var r = {};
                    return (
                      (r[f.signUpProperty.LAST_NAME] =
                        e[f.signUpProperty.LAST_NAME]),
                      (r[f.signUpProperty.EMAIL_ID] =
                        e[f.signUpProperty.EMAIL_ID]),
                      void 0 !== e[f.signUpProperty.FIRST_NAME] &&
                        (r[f.signUpProperty.FIRST_NAME] =
                          e[f.signUpProperty.FIRST_NAME]),
                      (n[f.signUpProperty.USER_DETAILS] = r),
                      c.RequestHandler.post({
                        body: n,
                        url: "/__catalyst/".concat(
                          i.ConfigManager.getInstance().ProjectID,
                          "/auth/signup"
                        ),
                      })
                    );
              ...
              value: function (e) {
                return this.isValidUser(e).then(function (e) {
                  return new Promise(function (t, n) {
                    401 === e.status
                      ? n(
                          _.ErrorHandler.constructError(
                            _.serverET.NET_ISSUE,
                            [],
                            _.ET_Mode.serverET
                          )
                        )
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  e.startsWith("/") &&
                    (e =
                      "" != t.CurrentClientPagePort
                        ? ""
                            .concat(t.CurrentClientPageProtocol, "//")
                            .concat(t.CurrentClientPageHost, ":")
                            .concat(t.CurrentClientPagePort)
                            .concat(e)
                        : ""
                            .concat(t.CurrentClientPageProtocol, "//")
                            .concat(t.CurrentClientPageHost)
                            .concat(e)),
                  ""
                    .concat(t.DomainUrl, "/logout?logout=true&PROJECT_ID=")
                    .concat(t.ZAID, "&serviceurl=")
                    .concat(e)
                );
              },
            },
            {
              ...
              value: function (e, t) {
                var n,
                  r,
                  o = i.ConfigManager.getInstance(),
                  a = !!e.signInProvidersOnly;
                if (e.css_url) n = e.css_url;
                else {
                  var c = e.signInProvidersOnly
                    ? f.AUTH_STATIC_FILES.SIGNIN_WITH_PROVIDERS_ONLY
                    : f.AUTH_STATIC_FILES.SIGNIN;
                ...
                e.service_url && "" !== e.service_url
                  ? ((r = e.service_url),
                    e.service_url.includes(window.location.origin) ||
                      u.test(e.service_url) ||
                      (r = ""
                        .concat(window.location.origin)
                        .concat(e.service_url)))
                  : l.get("service_url") &&
                    "" !== l.get("service_url") &&
                    ((r = l.get("service_url")),
                    l.get("service_url").includes(window.location.origin) ||
                      u.test(l.get("service_url")) ||
                      (r = ""
                        .concat(window.location.origin)
                        .concat(l.get("service_url"))));
                var E = encodeURIComponent(
                  ""
                    .concat(location.protocol, "//")
                    .concat(location.host, "/__catalyst/")
                    .concat(o.ProjectID, "/auth/signin-redirect?PROJECT_ID=")
                    .concat(o.ZAID)
                );
                return (
                  r &&
                    (E = encodeURIComponent(
                      ""
                        ...
                        .concat(o.ZAID, "&service_url=")
                        .concat(r)
                    )),
                  ""
                    .concat(location.protocol, "//")
                    .concat(location.host, "/accounts/p/")
                    .concat(o.ZAID, "/signin?css_url=")
                    .concat(n, "&portal=")
                    .concat(o.ZAID, "&servicename=ZohoCatalyst&serviceurl=")
                    .concat(E, "&hide_signup=true&hide_fs=")
                    .concat(!t, "&dcc=true&hide_fp=")
                    .concat(a)
                );
              },
            },
            {
              ...
              value: function (e) {
                var t = document
                    .getElementById("iam_iframe")
                    .contentWindow.document.getElementById("login_id").value,
                  n = i.ConfigManager.getInstance(),
                  r = e.forgot_password_css_url
                    ? e.forgot_password_css_url
                    : s.applyQueryString(f.AUTH_STATIC_FILES.URL, {
                ...
                return ""
                  .concat(location.protocol, "//")
                  .concat(location.host, "/accounts/p/")
                  .concat(n.ZAID, "/password?css_url=")
                  .concat(r, "&portal=")
                  .concat(n.ZAID, "&servicename=ZohoCatalyst&serviceurl=")
                  .concat(o, "&hide_signup=true&dcc=true&LOGIN_ID=")
                  .concat(encodeURIComponent(t.toString()));
              },
            },
            {
              key: "styleIFrame",
            ...
            },
            {
              ...
              value: function (e) {
                var t = i.ConfigManager.getInstance();
                return (
                  (t.fetchJwtDetailsCallBack = e),
                  (t.AuthProtocol = i.Auth_Protocol.JwtTokenProtocol),
                  new Promise(function (e, t) {
                    l.ResponseHandler.getJWTAuthToken()
                      .then(function (t) {
                        e(t);
                      })
                      .catch(function (e) {
            ...
            },
            {
              key: "getHeaders",
              value: function () {
                return l.ResponseHandler.attachAuthHeaders(
                  a.CONSTANT.EMPTY_OBJECT
                );
              },
            },
            {
              ...
              value: function (e) {
                ...
                if (e && 0 !== e.length) {
                  ...
                  t
                    ? ((o = null), (n.href = "".concat(e)))
                    : (n.href = "".concat(e).concat(o));
                } else console.error("redirect url missing.");
              },
            },
          ]) && r(t.prototype, n),
          T && r(t, T),
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.USER_MANAGEMENT_QUERY_STRING = { EMAIL_ID: "emailId" });
  },
  function (e, t, n) {
    n(29), (e.exports = n(23));
  },
  ...
  function (e, t, n) {
    n(31), (e.exports = n(7).Object.assign);
  },
  function (e, t, n) {
    var r = n(32);
    r(r.S + r.F, "Object", { assign: n(42) });
  },
  function (e, t, n) {
    var r = n(6),
      o = n(7),
      ...
      u = function (e, t, n) {
        var s,
          ...
          p = e & u.P,
          h = e & u.B,
          R = T ? r : d ? r[t] || (r[t] = {}) : (r[t] || {}).prototype,
          y = T ? o : o[t] || (o[t] = {}),
          I = y.prototype || (y.prototype = {});
        for (s in (T && (n = t), n))
          ...
          (this._bodyInit = e),
            e
              ? "string" == typeof e
                ...
                : c && (ArrayBuffer.prototype.isPrototypeOf(e) || s(e))
  ...
  function (e, t, n) {
    ...
    (function (e, t) {
      ...
      "Promise" in E
        ? E.Promise.prototype.finally || (E.Promise.prototype.finally = n)
        : (E.Promise = i);
      ...
      !(function (e, n) {
        ...
        if (!e.setImmediate) {
          var r,
            ...
            l = !1,
            f = e.document,
            E = Object.getPrototypeOf && Object.getPrototypeOf(e);
  ...
  function (e, t) {
    ...
    function E() {
      l &&
        u &&
        ((l = !1), u.length ? (s = u.concat(s)) : (f = -1), s.length && _());
    }
    function _() {
      if (!l) {
        var e = c(E);
    ...
    (o.nextTick = function (e) {
      ...
      s.push(new T(e, t)), 1 !== s.length || l || c(_);
    }),
          ...
          (g.prototype = {
            ...
            finish: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                ...
                if (n.finallyLoc === e)
                  return this.complete(n.completion, n.afterLoc), N(n), l;
              }
            },
            catch: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
  ...
  function (e, t, n) {
    ...
    (a[o.PROJECT] = r.ON),
      ...
      (t.REQUIREMENT = { INIT_REQUIRE: ["zaid", "project_id"] }),
      (t.APP_URL_DIVIDER = { PROJECT: "project" });
  },
  function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.CatalystDeveloperError =
        t.CatalystServerError =
        t.CatalystAppError =
        t.CatalystError =
          void 0);
    var l = (function () {
    ...
    var f = (function (e) {
      function t(e, n, r, a) {
        return (
          u(this, t), o(this, i(t).call(this, "app://".concat(e), n, r, a))
        );
      }
      return a(t, e), t;
    })(l);
    ...
    var E = (function (e) {
      function t(e, n, r, a) {
        return (
          u(this, t), o(this, i(t).call(this, "server://".concat(e), n, r, a))
        );
      }
      return a(t, e), t;
    })(l);
  ...
  function (e, t, n) {
        ...
        (o = [
          {
            ...
            value: function () {
              return (
                null === e.INSTANCE && (e.INSTANCE = new e()), this.INSTANCE
              );
            },
          },
        ]),
    ...
    (t.CommonPool = o), (o.INSTANCE = null);
  },
  function (e, t, n) {
    "use strict";
    function r(e, t) {
      ...
      E = (function () {
        function e() {
          !(function (e, t) {
            ...
            (this.URL = ""
              .concat(a.ConfigManager.getInstance().BaseURL, "/")
              .concat(c.TABLE_URL_DIVIDER.TABLE));
        }
        var t, n, E;
        return (
          (t = e),
          (n = [
            {
              ...
              value: function (e) {
                ...
                return {
                  ...
                  getColumns: function () {
                    return l.RequestHandler.get(
                      "".concat(t, "/").concat(c.TABLE_URL_DIVIDER.COLUMN)
                    );
                  },
                  addRow: function (e) {
                    return f
                      ...
                      .then(function () {
                        return l.RequestHandler.post({
                          ...
                          url: ""
                            .concat(t, "/")
                            .concat(c.TABLE_URL_DIVIDER.ROW),
                        });
                      });
                  },
                  updateRow: function (e) {
                    return f
                      .wrapPrimaryCheckWithPromise(function () {
                        s.PropertyCheckFilter.everyHasSuffInfo(e, [
                          c.TABLE_PROPERTY.ROW_ID,
                        ]);
                      })
                      .then(function () {
                  ...
                  getPagedRows: function () {
                    var e =
                      ...
                      o = {};
                    return (
                      void 0 !== n && n.length > 0 && (o.next_token = n),
                      void 0 !== r && (o.max_rows = r),
                      l.RequestHandler.get(
                        f.applyQueryString(
                          "".concat(t, "/").concat(c.TABLE_URL_DIVIDER.ROW),
                          o
                        )
                      )
                    );
                            ...
                            for (;;)
                              switch ((e.prev = e.next)) {
                                ...
                                case 1:
                                  return (
                                    (e.next = 3),
                                    o(this.getPagedRows({ next_token: t }))
                                  );
                                case 3:
                                  (n = e.sent),
                                    (r = !0),
                                ...
                                case 9:
                                  ...
                                  return (s = u.value), (e.next = 13), o(s);
                                case 13:
                                  return (e.next = 15), e.sent;
                                case 15:
                                  (r = !0), (e.next = 9);
                                  break;
                                case 18:
                  ...
                  columnId: function (e) {
                    var n = ""
                      .concat(t, "/")
                      .concat(c.TABLE_URL_DIVIDER.COLUMN, "/")
                      .concat(e);
                    return {
                      get: function () {
                  ...
                  deleteRows: function (e) {
                    ...
                    return l.RequestHandler.delete({
                      url: "".concat(f.applyQueryString(n, { ids: e })),
      ...
      E = (function () {
        function e() {
          !(function (e, t) {
            ...
            (this.URL = ""
              .concat(o.ConfigManager.getInstance().BaseURL, "/")
              .concat(s.FILE_URL_DIVIDER.FOLDER));
        }
        var t, n, E;
        return (
          (t = e),
          (n = [
            {
              ...
              value: function (e) {
                "number" == typeof e
                  ...
                  : u.TypeCheckFilter.validStr(e),
                  c.PropertyCheckFilter.stringLength(
                    e.toString(),
                    i.CONSTANT.MT_ID_LENGTH,
                    a.STRING_LENGTH_CONDITION.GREATER_THAN_EQUAL
                  );
                var t = "".concat(this.URL, "/").concat(e);
                return {
                  update: function (e) {
                    ...
                    return (
                      (n.folder_name = e),
                      l.RequestHandler.put({ body: n, url: t })
                    );
                  },
                  get: function () {
                    return l.RequestHandler.get(t);
                  ...
                  fileId: function (e) {
                    ...
                    var n = ""
                      .concat(t, "/")
                      .concat(s.FILE_URL_DIVIDER.FILE, "/")
                      .concat(e);
                    return {
                      get: function () {
                        return l.RequestHandler.get(n);
                        ...
                        return f.ResponseHandler.wrapResponse(
                          {
                            data: JSON.stringify({
                              data: {
                                download_url: ""
                                  .concat(n, "/")
                                  .concat(s.FILE_URL_DIVIDER.DOWNLOAD),
                              },
                            }),
                          },
                          !0
                  ...
                  uploadFile: function (e) {
                    var n =
                      ...
                      r = new FormData();
                    return (
                      r.append(s.FILE_PROPERTY.BLOB_NAME, e),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  (t.folder_name = e),
                  l.RequestHandler.post({ body: t, url: this.URL })
                );
              },
            },
          ]) && r(t.prototype, n),
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.FILE_MANDITORY = {
        PERMISSION_BODY: [
          t.FILE_PROPERTY.APP_ADMINISTRATOR,
          t.FILE_PROPERTY.APP_USER,
        ],
      }),
      (t.FILE_URL_DIVIDER = {
        FOLDER: "folder",
      ...
      _ = (function () {
        function e() {
          !(function (e, t) {
            ...
            (this.URL = ""
              .concat(o.ConfigManager.getInstance().BaseURL, "/")
              .concat(a.USER_MANAGEMENT_URL_DIVIDER.PROJECT_USER));
        }
        var t, n, _;
        return (
          (t = e),
          (n = [
            {
              ...
              value: function (e) {
                l.TypeCheckFilter.validStrIntOrInt(e),
                  s.PropertyCheckFilter.stringLength(
                    e.toString(),
                    c.CONSTANT.MT_ID_LENGTH,
                    u.STRING_LENGTH_CONDITION.GREATER_THAN_EQUAL
                  );
                var t = "".concat(this.URL, "/").concat(e);
                return {
                  get: function () {
                  ...
                  delete: function () {
                    return i.RequestHandler.delete({ body: {}, url: t });
                  },
                  update: function (e) {
                    return f
                      .wrapPrimaryCheckWithPromise(function () {
                        s.PropertyCheckFilter.hasSuffInfo(e, [
                          a.USER_MANAGEMENT_PROPERTY.LAST_NAME,
                          a.USER_MANAGEMENT_PROPERTY.EMAIL_ID,
                        ]);
                      })
                      .then(function () {
                        return i.RequestHandler.put({ body: e, url: t });
                      });
                  },
                };
              },
            },
            {
              ...
              value: function () {
                return i.RequestHandler.get(
                  ""
                    .concat(this.URL, "/")
                    .concat(a.USER_MANAGEMENT_URL_DIVIDER.CURRENT)
                ).then(function (e) {
                  return new Promise(function (t, n) {
                    401 === e.status
                      ? n(
                          E.ErrorHandler.constructError(
                            E.serverET.NET_ISSUE,
                            [],
                            E.ET_Mode.serverET
                          )
                        )
              ...
              value: function (e) {
                ...
                return f
                  .wrapPrimaryCheckWithPromise(function () {
                    s.PropertyCheckFilter.hasSuffInfo(e, [
                      a.USER_MANAGEMENT_PROPERTY.LAST_NAME,
                      a.USER_MANAGEMENT_PROPERTY.ZAAID,
                      a.USER_MANAGEMENT_PROPERTY.EMAIL_ID,
                    ]);
                  })
                  .then(function () {
                    ...
                    (r[a.USER_MANAGEMENT_PROPERTY.ZAID] = n.ZAID),
                      (r[a.USER_MANAGEMENT_PROPERTY.PLATFORM] =
                        void 0 === e[a.USER_MANAGEMENT_PROPERTY.PLATFORM]
                          ? "web"
                          : e[a.USER_MANAGEMENT_PROPERTY.PLATFORM]),
                      void 0 !== e[a.USER_MANAGEMENT_PROPERTY.REDIRECT_URL] &&
                        (r[a.USER_MANAGEMENT_PROPERTY.REDIRECT_URL] =
                          e[a.USER_MANAGEMENT_PROPERTY.REDIRECT_URL]);
                    var o = {};
                    return (
                      (o[a.USER_MANAGEMENT_PROPERTY.LAST_NAME] =
                        e[a.USER_MANAGEMENT_PROPERTY.LAST_NAME]),
                      (o[a.USER_MANAGEMENT_PROPERTY.EMAIL_ID] =
                        e[a.USER_MANAGEMENT_PROPERTY.EMAIL_ID]),
                      (o[a.USER_MANAGEMENT_PROPERTY.ZAAID] =
                        e[a.USER_MANAGEMENT_PROPERTY.ZAAID]),
                      void 0 !== e[a.USER_MANAGEMENT_PROPERTY.FIRST_NAME] &&
                        (o[a.USER_MANAGEMENT_PROPERTY.FIRST_NAME] =
                          e[a.USER_MANAGEMENT_PROPERTY.FIRST_NAME]),
                      (r[a.USER_MANAGEMENT_PROPERTY.USER_DETAILS] = o),
                      i.RequestHandler.post({ body: r, url: t.URL })
                    );
                  });
              },
            },
                ...
                return f
                  ...
                  .then(function () {
                    ...
                    return (
                      (o[a.USER_MANAGEMENT_PROPERTY.EMAIL_ID] =
                        e[a.USER_MANAGEMENT_PROPERTY.EMAIL_ID]),
                      void 0 !== e[a.USER_MANAGEMENT_PROPERTY.LAST_NAME] &&
                        (o[a.USER_MANAGEMENT_PROPERTY.LAST_NAME] =
                          e[a.USER_MANAGEMENT_PROPERTY.LAST_NAME]),
                      void 0 !== e[a.USER_MANAGEMENT_PROPERTY.FIRST_NAME] &&
                        (o[a.USER_MANAGEMENT_PROPERTY.FIRST_NAME] =
                      ...
                      i.RequestHandler.post({
                        ...
                        url: ""
                          .concat(t.URL, "/")
                          .concat(
                            a.USER_MANAGEMENT_URL_DIVIDER.FORGOT_PASSWORD
                          ),
                      })
                    );
                  });
      ...
      u = (function () {
        function e() {
          !(function (e, t) {
            ...
            (this.URL = ""
              .concat(o.ConfigManager.getInstance().BaseURL, "/")
              .concat(a.FUNCTION_URL_DIVIDER.FUNCTION));
        }
        var t, n, u;
        return (
          (t = e),
          (n = [
            {
              ...
              value: function (e) {
                var t = ""
                  .concat(
                    o.ConfigManager.getInstance().CurrentClientPageDomain,
                    "/"
                  )
                  .concat(a.FUNCTION_URL_DIVIDER.SERVER, "/")
                  .concat(e, "/")
                  .concat(a.FUNCTION_URL_DIVIDER.EXECUTE);
                return {
                  execute: function (e) {
                    null == e ||
                      !e.hasOwnProperty("isProduction") ||
                      e.isProduction,
                      null != e && e.hasOwnProperty("path") && e.path;
                    var n =
                      null != e && e.hasOwnProperty("args")
                        ? e.args
                        : null != e && e.hasOwnProperty("params")
                        ? e.params
                        : {};
                    switch (
                      null != e && e.hasOwnProperty("method")
                      ...
                      default:
                        return i.RequestHandler.rawRemote.get(
                          c.applyQueryString(t, n)
                        );
                    }
                  },
                };
      ...
      l = (function () {
        function e() {
          !(function (e, t) {
            ...
            (this.URL = ""
              .concat(o.ConfigManager.getInstance().BaseURL, "/")
              .concat(a.ZCatalyst_QL_URL_DIVIDER.QUERY));
        }
        var t, n, l;
        return (
          (t = e),
          (n = [
            {
              ...
              value: function (e) {
                ...
                if (
                  ((t.query = e),
                  void 0 !==
                    u.__init__.getEnvironmentVariable(
                      a.ZCatalyst_QL_URL_DIVIDER.ZCQL_V2_ENV_KEY
                    ) &&
                    u.__init__.getEnvironmentVariable(
                      a.ZCatalyst_QL_URL_DIVIDER.ZCQL_V2_ENV_KEY
                    ) === a.ZCatalyst_QL_URL_DIVIDER.ZCQL_V2_ENV_VALUE)
                ) {
                  var n = {};
                  return (
                    (n[a.ZCatalyst_QL_URL_DIVIDER.ACCEPT] =
                      a.ZCatalyst_QL_URL_DIVIDER.ZCQL_V2_HEADER_VALUE),
                    (n[a.ZCatalyst_QL_URL_DIVIDER.CONTENT_TYPE] =
                      s.HTTP_HEADER_MAP.CONTENT_JSON),
                    i.RequestHandler.post({ body: t, url: this.URL }, n)
                  );
                }
                return i.RequestHandler.post({ body: t, url: this.URL });
              },
            },
          ]) && r(t.prototype, n),
          l && r(t, l),
          ...
          (n = [
            {
              ...
              value: function (e) {
                return i.RequestHandler.post({
                  ...
                  url: ""
                    .concat(this.URL, "/")
                    .concat(a.SEARCH_URL_DIVIDER.SEARCH),
                });
              },
            },
          ]) && r(t.prototype, n),
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.SEARCH_URL_DIVIDER = { SEARCHINDEX: "searchIndex", SEARCH: "search" });
  },
  function (e, t, n) {
    "use strict";
    function r(e, t) {
          ...
          (n = [
            {
              ...
              value: function () {
                var t = ""
                    .concat(this.URL, "/")
                    .concat(a.NOTIFICATION_URL_DIVIDER.PROJECT_USER, "/")
                    .concat(a.NOTIFICATION_URL_DIVIDER.NOTIFICATION_CLIENT),
                  n = c.applyQueryString(t, { isRTCP: !0 });
                return new Promise(function (t) {
                  i.RequestHandler.get(n)
                    .then(function (n) {
                      if (void 0 !== n.status && 200 == n.status) {
                        ...
                        (r.src = n.content.url),
                          ...
                          (r.onload = function () {
                            void 0 !== n.content.sazuid &&
                            void 0 !== n.content.clientaccesstoken
                              ? new e().initWmsRTCP(
                                  n.content.uid,
                                  o.ConfigManager.getInstance().ZAID,
                                  n.content.sazuid,
                                  n.content.clientaccesstoken
                                )
                              : new e().initWmsZmp(
                                  n.content.uid,
                                  o.ConfigManager.getInstance().ZAID
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.Project = void 0);
    var o = n(1),
      i = n(82),
      a = n(0),
      c = n(8),
      ...
      f = (function () {
        function e() {
          ...
          this.URL = ""
            .concat(t.DomainUrl, "/")
            .concat(t.UrlVersion, "/")
            .concat(i.PROJECT_URL_DIVIDER.PROJECT);
        }
        var t, n, f;
        return (
          (t = e),
          (n = [
            {
              ...
              value: function (e) {
                s.TypeCheckFilter.validStrIntOrInt(e),
                  u.PropertyCheckFilter.stringLength(
                    e.toString(),
                    a.CONSTANT.MT_ID_LENGTH,
                    c.STRING_LENGTH_CONDITION.GREATER_THAN_EQUAL
                  );
                var t = "".concat(this.URL, "/").concat(e);
                return {
                  getProjectTimezone: function () {
                    return l.RequestHandler.get(
                      "".concat(t, "/").concat(i.PROJECT_URL_DIVIDER.TIMEZONE)
                    );
                  },
                };
              },
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.PROJECT_URL_DIVIDER = { PROJECT: "project", TIMEZONE: "timezone" }),
      (t.PROJECT_PROPERTY = { PROJECT_NAME: "project_name" });
  },
]);
